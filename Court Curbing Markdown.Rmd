...
See notes section for a breakdown of the different model variations and the robustness of the results


# Ideas

Create figures that show the ideological distance by type (I may have already done this)
Run models of elections without the ideological distance variables
...
gavelCultureControl$legislativeControl <- ifelse(gavelCultureControl$RepublicanLegslature == 1, "Republican", 
                                                 ifelse(gavelCultureControl$SplitLegislature == 1, "Split",
                                                        "Democratic"))
table(gavelCultureControl$legislativeControl, gavelCultureControl$legislativeControl)
