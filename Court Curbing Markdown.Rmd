...
DO IDEOLOGY WITH FEWER YEARS (MORE PROPER), THEN DO FULLER MODELS WITHOUT IDEOLOGY
...
Using less data (fewer years), the model is no longer significant.  Maybe run smaller model with ideology and then full model without ideology!!!!!!
